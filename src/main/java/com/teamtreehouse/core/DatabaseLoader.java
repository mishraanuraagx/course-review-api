...
public class DatabaseLoader implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) throws Exception {
    ...
    users.save(students);
    users.save(new User("craigdennis","Craig", "Dennis","12345",new String[]{"ROLE_USER", "ROLE_ADMIN"}));
    users.save(new User("mishraanuraag","Anuraag", "Mishra","99999",new String[]{"ROLE_USER", "ROLE_ADMIN"}));
